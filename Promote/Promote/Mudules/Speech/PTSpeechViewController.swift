...
class PTSpeechViewController: UIViewController {
    ...
    func setupTextView() {
        ...
        textView.attributedText = NSAttributedString.init(string: str, attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 16), NSAttributedString.Key.foregroundColor: UIColor.red, NSAttributedString.Key.paragraphStyle: paragraph])
    }
